...
case class Ok[T](
  ...
  @(ApiModelProperty @field)(value    = "结果字段", dataType = "object") data:         T) extends Response

@ApiModel
case class Error(
  @(ApiModelProperty @field)(
    value           = "业务状态码",
    dataType        = "int", required = true, allowableValues = "5000") status: Int = 5000,
  @(ApiModelProperty @field)(value    = "提示消息", dataType = "string", required = true) message:String= "错误",
  @(ApiModelProperty @field)(value    = "错误描述", dataType = "string") moreInfo:     String) extends Response
